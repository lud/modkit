defmodule Modkit.CLI.UsageFormat.OptionFormatter.Markdown do
  alias Modkit.CLI.Argument
  alias Modkit.CLI.Option

  @moduledoc false

  @behaviour Modkit.CLI.UsageFormat

  @impl true
  def format_head(_, _, _) do
    nil
  end

  @impl true
  def format_synopsis(iodata, _) do
    ["    ", iodata, "\n"]
  end

  @impl true
  def format_section(title, content, _) do
    ["## ", title, "\n\n", content]
  end
  ...
  defp doc(%Option{doc_arg: doc_arg}) do
    [" <", doc_arg, ">"]
  end
